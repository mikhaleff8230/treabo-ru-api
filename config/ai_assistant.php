...
return [
    ...
    'prompt_version' => env('AI_REQUEST_ASSISTANT_PROMPT_VERSION', 'request-assistant-v4'),
    'max_ai_calls' => (int) env('AI_REQUEST_ASSISTANT_MAX_CALLS', 6),
    'soft_question_limit' => (int) env('AI_REQUEST_ASSISTANT_SOFT_QUESTIONS', 5),
    'semantic_clarification_limit' => (int) env('AI_REQUEST_ASSISTANT_SEMANTIC_CLARIFICATIONS', 3),
    ...
    'request_timeout_seconds' => (int) env('AI_REQUEST_ASSISTANT_TIMEOUT_SECONDS', 10),
    'connect_timeout_seconds' => (int) env('AI_REQUEST_ASSISTANT_CONNECT_TIMEOUT_SECONDS', 5),
    'pricing' => [
