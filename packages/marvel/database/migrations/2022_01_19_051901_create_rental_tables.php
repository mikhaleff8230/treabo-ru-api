...
class CreateRentalTables extends Migration
{
    ...
    public function up()
    {
        ...
        if (! Schema::hasTable('dropoff_location_product')) {
        ...
        if (! Schema::hasTable('pickup_location_product')) {
        ...
        if (! Schema::hasTable('deposit_product')) {
        ...
        if (! Schema::hasTable('person_product')) {
